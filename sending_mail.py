...
# server.starttls()
# server.login("jyotika.8792@gmail.com", "password")
sender_email = "jyotika.8792@gmail.com"
rec_email = "jyotika.8792@gmail.com"
password = input(str("Please enter your password : "))

message = "Table Creates Successfully"
message1 = "Value inserted Successfully"
message2 = "Deleted Successfully"
message3 = "Updated Successfully"
...
class mysqlOperations:
        ...
        try:
            while True:
                ...
                for i in data:
                    ...
                    self.mycursor.execute(query)
                    print("Table created ")
                    #server.sendmail("jyotika.8792@gmail.com", "jyotika.8792@gmail.com", "Table Created!!")
                    server.sendmail(sender_email, rec_email, message)
                    print("mail sent", rec_email)
                    choice=""
    ...
    def insert_table(self):
        try:
            ...
            if user_choice == 1:
                ...
                self.print_data(table_name)
                #server.sendmail("jyotika.8792@gmail.com", "jyotika.8792@gmail.com", "Value inserted successfully!!")
    ...
    def print_data(self,table):
        try:
            ...
            print("Error while retreiving the data ")
            print(e)
    ...
    def delete_data(self):
        try:
            ...
            if query != "":
                ...
                #server.sendmail("jyotika.8792@gmail.com", "jyotika.8792@gmail.com", "Successfully deleted!!")
    ...
    def update_table(self):
        try:
            ...
            self.print_data(input_table)
            #server.sendmail("jyotika.8792@gmail.com", "jyotika.8792@gmail.com", "Updated successfully!!")
